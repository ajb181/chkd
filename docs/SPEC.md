...
- [x] **1.2 Database Layer** - SQLite for repos, sessions, bugs
- [x] **1.3 Spec Parser** - Parse SPEC.md into structured data
- [x] **1.4 Spec Writer** - Modify SPEC.md (toggle items, add items)
